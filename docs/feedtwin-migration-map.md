...
| `teams.teamPublicId` | Preserve the existing public identifier. Stripe references this identifier. Add an authorized import API before migration. The current `createTeam` generates a new identifier. |
...
1. Add an import API that preserves public identifiers and checks membership uniqueness and ownership consistency.
