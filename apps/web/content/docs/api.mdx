...
The API targets the first stable version, `1.0.0`. See the [typed client source](https://github.com/clipinfit/convex-teams/blob/main/packages/convex-teams/src/client/index.ts) for exact argument types.
...
The scoped package includes these exports. See the [installation guide](/docs/getting-started) and current [release status](/docs/release-status).
