...
The API targets the first release candidate, `1.0.0-rc.0`. See the [typed client source](https://github.com/clipinfit/convex-teams/blob/main/packages/convex-teams/src/client/index.ts) for exact argument types.
