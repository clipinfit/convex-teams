...
Before upgrading an existing deployment, review its data. Define a migration or revoke and reissue old invitations. Stable public identifiers and a real consumer migration rehearsal are still release gates.
